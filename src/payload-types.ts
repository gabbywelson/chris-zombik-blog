...
export interface Page {
  ...
  title: string;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact' | 'authorHero';
    richText?: {
      root: {
        type: string;
        children: {
    ...
    /**
     * Introduction and bio displayed next to the author photo
     */
    authorBio?: {
      root: {
        type: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LatestWorksBlock".
 */
export interface LatestWorksBlock {
  heading?: string | null;
  /**
...
export interface ShortStory {
  ...
  title: string;
  /**
   * A brief summary for display on listing pages
   */
  summary?: string | null;
  content: {
    root: {
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        latestWorks?: T | LatestWorksBlockSelect<T>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LatestWorksBlock_select".
 */
export interface LatestWorksBlockSelect<T extends boolean = true> {
  heading?: T;
  description?: T;
  count?: T;
  id?: T;
...
export interface BlockQuoteBlock {
  ...
  /**
   * Optional attribution for the quote (e.g., author name, book title)
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "FootnoteReferenceBlock".
 */
export interface FootnoteReferenceBlock {
  /**
   * This text appears in the footnotes section at the bottom of the post.
   */
  content: {
    root: {
      type: string;
